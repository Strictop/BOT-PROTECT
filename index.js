...
const client = new Client({
    intents: [
        GatewayIntentBits.GUILDS, GatewayIntentBitsBits.GUILD_MEMBERS, GatewayIntentBitsBits.GUILD_BANS, 
        GatewayIntentBitsBits.GUILD_EMOJIS_AND_STICKERS, GatewayIntentBitsBits.GUILD_INTEGRATIONS, 
        GatewayIntentBitsBits.GUILD_WEBHOOKS, GatewayIntentBitsBits.GUILD_INVITES, GatewayIntentBitsBits.GUILD_VOICE_STATES, 
        GatewayIntentBitsBits.GUILD_PRESENCES, GatewayIntentBitsBits.GUILD_MESSAGES, GatewayIntentBitsBits.GUILD_MESSAGE_REACTIONS, 
        GatewayIntentBits.GUILD_MESSAGE_TYPING, GatewayIntentBitsBits.DIRECT_MESSAGES, 
        GatewayIntentBits.DIRECT_MESSAGE_REACTIONS, GatewayIntentBits.DIRECT_MESSAGE_TYPING
    ],
    restTimeOffset: 0,
